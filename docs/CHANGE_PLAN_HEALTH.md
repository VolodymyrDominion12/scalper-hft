...
> **Наступний цикл (2026-09-09):** [CHANGE_PLAN_REVIEW.md](CHANGE_PLAN_REVIEW.md)
> (R1 fill-parity — зробити **до** старту/рестарту 8-тижневого gate).
> H1–H8 нижче **закриті в коді**.
