...
> **Поточний цикл (2026-09-09):** [CHANGE_PLAN_REVIEW.md](CHANGE_PLAN_REVIEW.md)
> (R1–R8: fill-parity, API bind, профілі .env). H1–H8:
> [CHANGE_PLAN_HEALTH.md](CHANGE_PLAN_HEALTH.md). Фази A–E нижче **закриті**.
