...
| ob_imbalance | даних замало | ⚠ потребує накопичення стакана |

**Чесний висновок**: жодна сигнальна стратегія не пройшла аудит — це правильний
результат циклу (система відхиляє edge, якого немає). Процес валідації при цьому
працює: paper-replay впіймав баг обліку funding, який інакше дав би хибний сигнал
до live. Кандидати на наступні ітерації: delta-neutral funding arb (перп+спот),
depth-weighted OB-стратегії, maker з L2-калібруванням.
